...
void protobuf_ShutdownFile_IM_2eServer_2eproto() {
  ...
  delete IMMsgServInfoReq::default_instance_;
  delete IMMsgServInfoRsp::default_instance_;
  delete IMUserLatestNickNameReq::default_instance_;
  delete IMUserLatestNickNameRsp::default_instance_;
  delete IMUserNickNameUpdate::default_instance_;
}
...
void protobuf_AddDesc_IM_2eServer_2eproto() {
  ...
  IMMsgServInfoReq::default_instance_ = new IMMsgServInfoReq();
  IMMsgServInfoRsp::default_instance_ = new IMMsgServInfoRsp();
  IMUserLatestNickNameReq::default_instance_ = new IMUserLatestNickNameReq();
  IMUserLatestNickNameRsp::default_instance_ = new IMUserLatestNickNameRsp();
  IMUserNickNameUpdate::default_instance_ = new IMUserNickNameUpdate();
  ...
  IMMsgServInfoReq::default_instance_->InitAsDefaultInstance();
  IMMsgServInfoRsp::default_instance_->InitAsDefaultInstance();
  IMUserLatestNickNameReq::default_instance_->InitAsDefaultInstance();
  IMUserLatestNickNameRsp::default_instance_->InitAsDefaultInstance();
  IMUserNickNameUpdate::default_instance_->InitAsDefaultInstance();
...
const int IMGetDeviceTokenReq::kDomainIdFieldNumber;
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(16)) goto parse_domain_id;
        break;
      }
...
void IMGetDeviceTokenReq::SerializeWithCachedSizes(
  ...
  // optional uint32 domain_id = 2 [default = 1000];
  if (has_domain_id()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(2, this->domain_id(), output);
  }
...
const int IMMsgServInfo::kPortWssFieldNumber;
const int IMMsgServInfo::kIpWssFieldNumber;
#endif  // !_MSC_VER
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 6: {
        ...
        if (input->ExpectTag(56)) goto parse_portWss;
        break;
      }
      ...
      case 7: {
        ...
        if (input->ExpectTag(66)) goto parse_ipWss;
        break;
      }
...
void IMMsgServInfo::SerializeWithCachedSizes(
  ...
  // required uint32 portWss = 7;
  if (has_portwss()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(7, this->portwss(), output);
  }
...
void IMMsgServInfo::MergeFrom(const IMMsgServInfo& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_portwss()) {
      set_portwss(from.portwss());
    }
    if (from.has_ipwss()) {
      set_ipwss(from.ipwss());
    }
  }
  mutable_unknown_fields()->append(from.unknown_fields());
}
...
void IMMsgServInfo::Swap(IMMsgServInfo* other) {
  if (other != this) {
    ...
    std::swap(portwss_, other->portwss_);
    std::swap(ipwss_, other->ipwss_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
    _unknown_fields_.swap(other->_unknown_fields_);
    std::swap(_cached_size_, other->_cached_size_);
  }
...
const int IMPushToUserReq::kToSessionIdFieldNumber;
const int IMPushToUserReq::kSessionTypeFieldNumber;
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 4: {
        ...
        if (input->ExpectTag(42)) goto parse_user_token_list;
        break;
      }
...
void IMPushToUserReq::SerializeWithCachedSizes(
  ...
  if (has_to_session_id()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt64(3, this->to_session_id(), output);
  }
  ...
  for (int i = 0; i < this->user_token_list_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessage(
      5, this->user_token_list(i), output);
  }
...
#ifndef _MSC_VER
const int IMMsgServInfoReq::kTimeStampFieldNumber;
#endif  // !_MSC_VER

IMMsgServInfoReq::IMMsgServInfoReq()
  : ::google::protobuf::MessageLite() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:IM.Server.IMMsgServInfoReq)
}

void IMMsgServInfoReq::InitAsDefaultInstance() {
}

IMMsgServInfoReq::IMMsgServInfoReq(const IMMsgServInfoReq& from)
  : ::google::protobuf::MessageLite() {
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:IM.Server.IMMsgServInfoReq)
}

void IMMsgServInfoReq::SharedCtor() {
  _cached_size_ = 0;
  time_stamp_ = 0u;
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}
...
IMMsgServInfoReq::~IMMsgServInfoReq() {
  // @@protoc_insertion_point(destructor:IM.Server.IMMsgServInfoReq)
  SharedDtor();
}

void IMMsgServInfoReq::SharedDtor() {
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  if (this != &default_instance()) {
  #else
  if (this != default_instance_) {
...
void IMMsgServInfoReq::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const IMMsgServInfoReq& IMMsgServInfoReq::default_instance() {
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  protobuf_AddDesc_IM_2eServer_2eproto();
#else
  if (default_instance_ == NULL) protobuf_AddDesc_IM_2eServer_2eproto();
...
IMMsgServInfoReq* IMMsgServInfoReq::default_instance_ = NULL;

IMMsgServInfoReq* IMMsgServInfoReq::New() const {
  return new IMMsgServInfoReq;
}

void IMMsgServInfoReq::Clear() {
  time_stamp_ = 0u;
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
  mutable_unknown_fields()->clear();
}

bool IMMsgServInfoReq::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  ::google::protobuf::io::StringOutputStream unknown_fields_string(
  ...
  ::google::protobuf::io::CodedOutputStream unknown_fields_stream(
      &unknown_fields_string);
  // @@protoc_insertion_point(parse_start:IM.Server.IMMsgServInfoReq)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:IM.Server.IMMsgServInfoReq)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:IM.Server.IMMsgServInfoReq)
  return false;
#undef DO_
}

void IMMsgServInfoReq::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:IM.Server.IMMsgServInfoReq)
  // required uint32 time_stamp = 1;
  if (has_time_stamp()) {
  ...
  output->WriteRaw(unknown_fields().data(),
                   unknown_fields().size());
  // @@protoc_insertion_point(serialize_end:IM.Server.IMMsgServInfoReq)
}

int IMMsgServInfoReq::ByteSize() const {
  int total_size = 0;
...
void IMMsgServInfoReq::CheckTypeAndMergeFrom(
    const ::google::protobuf::MessageLite& from) {
  MergeFrom(*::google::protobuf::down_cast<const IMMsgServInfoReq*>(&from));
}

void IMMsgServInfoReq::MergeFrom(const IMMsgServInfoReq& from) {
  GOOGLE_CHECK_NE(&from, this);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
...
void IMMsgServInfoReq::CopyFrom(const IMMsgServInfoReq& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool IMMsgServInfoReq::IsInitialized() const {
  if ((_has_bits_[0] & 0x00000001) != 0x00000001) return false;

  return true;
}

void IMMsgServInfoReq::Swap(IMMsgServInfoReq* other) {
  if (other != this) {
...
::std::string IMMsgServInfoReq::GetTypeName() const {
  return "IM.Server.IMMsgServInfoReq";
}
...
#ifndef _MSC_VER
const int IMMsgServInfoRsp::kTimeStampFieldNumber;
const int IMMsgServInfoRsp::kMsgServInfoFieldNumber;
#endif  // !_MSC_VER

IMMsgServInfoRsp::IMMsgServInfoRsp()
  : ::google::protobuf::MessageLite() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:IM.Server.IMMsgServInfoRsp)
}

void IMMsgServInfoRsp::InitAsDefaultInstance() {
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  msg_serv_info_ = const_cast< ::IM::Server::IMMsgServInfo*>(
      ::IM::Server::IMMsgServInfo::internal_default_instance());
#else
  msg_serv_info_ = const_cast< ::IM::Server::IMMsgServInfo*>(&::IM::Server::IMMsgServInfo::default_instance());
#endif
}

IMMsgServInfoRsp::IMMsgServInfoRsp(const IMMsgServInfoRsp& from)
  : ::google::protobuf::MessageLite() {
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:IM.Server.IMMsgServInfoRsp)
}

void IMMsgServInfoRsp::SharedCtor() {
  _cached_size_ = 0;
  time_stamp_ = 0u;
  msg_serv_info_ = NULL;
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
...
IMMsgServInfoRsp::~IMMsgServInfoRsp() {
  // @@protoc_insertion_point(destructor:IM.Server.IMMsgServInfoRsp)
  SharedDtor();
}

void IMMsgServInfoRsp::SharedDtor() {
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  if (this != &default_instance()) {
  #else
  if (this != default_instance_) {
...
void IMMsgServInfoRsp::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const IMMsgServInfoRsp& IMMsgServInfoRsp::default_instance() {
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  protobuf_AddDesc_IM_2eServer_2eproto();
#else
  if (default_instance_ == NULL) protobuf_AddDesc_IM_2eServer_2eproto();
...
IMMsgServInfoRsp* IMMsgServInfoRsp::default_instance_ = NULL;

IMMsgServInfoRsp* IMMsgServInfoRsp::New() const {
  return new IMMsgServInfoRsp;
}

void IMMsgServInfoRsp::Clear() {
  if (_has_bits_[0 / 32] & 3) {
    time_stamp_ = 0u;
    if (has_msg_serv_info()) {
...
bool IMMsgServInfoRsp::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  ::google::protobuf::io::StringOutputStream unknown_fields_string(
  ...
  ::google::protobuf::io::CodedOutputStream unknown_fields_stream(
      &unknown_fields_string);
  // @@protoc_insertion_point(parse_start:IM.Server.IMMsgServInfoRsp)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(18)) goto parse_msg_serv_info;
        break;
      }
...
success:
  // @@protoc_insertion_point(parse_success:IM.Server.IMMsgServInfoRsp)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:IM.Server.IMMsgServInfoRsp)
  return false;
#undef DO_
}

void IMMsgServInfoRsp::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:IM.Server.IMMsgServInfoRsp)
  // required uint32 time_stamp = 1;
  if (has_time_stamp()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(1, this->time_stamp(), output);
  }
  ...
  if (has_msg_serv_info()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessage(
      2, this->msg_serv_info(), output);
  }

  output->WriteRaw(unknown_fields().data(),
                   unknown_fields().size());
  // @@protoc_insertion_point(serialize_end:IM.Server.IMMsgServInfoRsp)
}

int IMMsgServInfoRsp::ByteSize() const {
  int total_size = 0;
...
void IMMsgServInfoRsp::CheckTypeAndMergeFrom(
    const ::google::protobuf::MessageLite& from) {
  MergeFrom(*::google::protobuf::down_cast<const IMMsgServInfoRsp*>(&from));
}

void IMMsgServInfoRsp::MergeFrom(const IMMsgServInfoRsp& from) {
  GOOGLE_CHECK_NE(&from, this);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_time_stamp()) {
      set_time_stamp(from.time_stamp());
    }
    if (from.has_msg_serv_info()) {
      mutable_msg_serv_info()->::IM::Server::IMMsgServInfo::MergeFrom(from.msg_serv_info());
    }
  }
  mutable_unknown_fields()->append(from.unknown_fields());
}

void IMMsgServInfoRsp::CopyFrom(const IMMsgServInfoRsp& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool IMMsgServInfoRsp::IsInitialized() const {
  if ((_has_bits_[0] & 0x00000003) != 0x00000003) return false;

  if (has_msg_serv_info()) {
    if (!this->msg_serv_info().IsInitialized()) return false;
  }
  return true;
}

void IMMsgServInfoRsp::Swap(IMMsgServInfoRsp* other) {
  if (other != this) {
    std::swap(time_stamp_, other->time_stamp_);
    std::swap(msg_serv_info_, other->msg_serv_info_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
    _unknown_fields_.swap(other->_unknown_fields_);
    std::swap(_cached_size_, other->_cached_size_);
  }
...
::std::string IMMsgServInfoRsp::GetTypeName() const {
  return "IM.Server.IMMsgServInfoRsp";
}
...
#ifndef _MSC_VER
const int IMUserLatestNickNameReq::kUserIdFieldNumber;
const int IMUserLatestNickNameReq::kAppIdFieldNumber;
const int IMUserLatestNickNameReq::kDomainIdFieldNumber;
const int IMUserLatestNickNameReq::kAttachDataFieldNumber;
#endif  // !_MSC_VER

IMUserLatestNickNameReq::IMUserLatestNickNameReq()
  : ::google::protobuf::MessageLite() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:IM.Server.IMUserLatestNickNameReq)
}

void IMUserLatestNickNameReq::InitAsDefaultInstance() {
}

IMUserLatestNickNameReq::IMUserLatestNickNameReq(const IMUserLatestNickNameReq& from)
  : ::google::protobuf::MessageLite() {
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:IM.Server.IMUserLatestNickNameReq)
}

void IMUserLatestNickNameReq::SharedCtor() {
  ::google::protobuf::internal::GetEmptyString();
  _cached_size_ = 0;
  user_id_ = GOOGLE_ULONGLONG(0);
  app_id_ = 0u;
...
IMUserLatestNickNameReq::~IMUserLatestNickNameReq() {
  // @@protoc_insertion_point(destructor:IM.Server.IMUserLatestNickNameReq)
  SharedDtor();
}

void IMUserLatestNickNameReq::SharedDtor() {
  if (attach_data_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete attach_data_;
  }
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
...
void IMUserLatestNickNameReq::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const IMUserLatestNickNameReq& IMUserLatestNickNameReq::default_instance() {
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  protobuf_AddDesc_IM_2eServer_2eproto();
#else
  if (default_instance_ == NULL) protobuf_AddDesc_IM_2eServer_2eproto();
...
IMUserLatestNickNameReq* IMUserLatestNickNameReq::default_instance_ = NULL;

IMUserLatestNickNameReq* IMUserLatestNickNameReq::New() const {
  return new IMUserLatestNickNameReq;
}

void IMUserLatestNickNameReq::Clear() {
#define OFFSET_OF_FIELD_(f) (reinterpret_cast<char*>(      \
  &reinterpret_cast<IMUserLatestNickNameReq*>(16)->f) - \
   reinterpret_cast<char*>(16))
...
bool IMUserLatestNickNameReq::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  ::google::protobuf::io::StringOutputStream unknown_fields_string(
  ...
  ::google::protobuf::io::CodedOutputStream unknown_fields_stream(
      &unknown_fields_string);
  // @@protoc_insertion_point(parse_start:IM.Server.IMUserLatestNickNameReq)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(16383);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:IM.Server.IMUserLatestNickNameReq)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:IM.Server.IMUserLatestNickNameReq)
  return false;
#undef DO_
}

void IMUserLatestNickNameReq::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:IM.Server.IMUserLatestNickNameReq)
  // required uint64 user_id = 1;
  if (has_user_id()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt64(1, this->user_id(), output);
  }
  ...
  output->WriteRaw(unknown_fields().data(),
                   unknown_fields().size());
  // @@protoc_insertion_point(serialize_end:IM.Server.IMUserLatestNickNameReq)
}

int IMUserLatestNickNameReq::ByteSize() const {
  int total_size = 0;
...
void IMUserLatestNickNameReq::CheckTypeAndMergeFrom(
    const ::google::protobuf::MessageLite& from) {
  MergeFrom(*::google::protobuf::down_cast<const IMUserLatestNickNameReq*>(&from));
}

void IMUserLatestNickNameReq::MergeFrom(const IMUserLatestNickNameReq& from) {
  GOOGLE_CHECK_NE(&from, this);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_user_id()) {
      set_user_id(from.user_id());
...
void IMUserLatestNickNameReq::CopyFrom(const IMUserLatestNickNameReq& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool IMUserLatestNickNameReq::IsInitialized() const {
  if ((_has_bits_[0] & 0x00000007) != 0x00000007) return false;

  return true;
}

void IMUserLatestNickNameReq::Swap(IMUserLatestNickNameReq* other) {
  if (other != this) {
    std::swap(user_id_, other->user_id_);
    std::swap(app_id_, other->app_id_);
    std::swap(domain_id_, other->domain_id_);
...
::std::string IMUserLatestNickNameReq::GetTypeName() const {
  return "IM.Server.IMUserLatestNickNameReq";
}
...
#ifndef _MSC_VER
const int IMUserLatestNickNameRsp::kUserIdFieldNumber;
const int IMUserLatestNickNameRsp::kAppIdFieldNumber;
const int IMUserLatestNickNameRsp::kDomainIdFieldNumber;
const int IMUserLatestNickNameRsp::kNickNameFieldNumber;
const int IMUserLatestNickNameRsp::kAttachDataFieldNumber;
#endif  // !_MSC_VER

IMUserLatestNickNameRsp::IMUserLatestNickNameRsp()
  : ::google::protobuf::MessageLite() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:IM.Server.IMUserLatestNickNameRsp)
}

void IMUserLatestNickNameRsp::InitAsDefaultInstance() {
}

IMUserLatestNickNameRsp::IMUserLatestNickNameRsp(const IMUserLatestNickNameRsp& from)
  : ::google::protobuf::MessageLite() {
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:IM.Server.IMUserLatestNickNameRsp)
}

void IMUserLatestNickNameRsp::SharedCtor() {
  ::google::protobuf::internal::GetEmptyString();
  _cached_size_ = 0;
  user_id_ = GOOGLE_ULONGLONG(0);
  app_id_ = 0u;
...
IMUserLatestNickNameRsp::~IMUserLatestNickNameRsp() {
  // @@protoc_insertion_point(destructor:IM.Server.IMUserLatestNickNameRsp)
  SharedDtor();
}

void IMUserLatestNickNameRsp::SharedDtor() {
...
void IMUserLatestNickNameRsp::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const IMUserLatestNickNameRsp& IMUserLatestNickNameRsp::default_instance() {
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  protobuf_AddDesc_IM_2eServer_2eproto();
#else
  if (default_instance_ == NULL) protobuf_AddDesc_IM_2eServer_2eproto();
...
IMUserLatestNickNameRsp* IMUserLatestNickNameRsp::default_instance_ = NULL;

IMUserLatestNickNameRsp* IMUserLatestNickNameRsp::New() const {
  return new IMUserLatestNickNameRsp;
}

void IMUserLatestNickNameRsp::Clear() {
#define OFFSET_OF_FIELD_(f) (reinterpret_cast<char*>(      \
  &reinterpret_cast<IMUserLatestNickNameRsp*>(16)->f) - \
   reinterpret_cast<char*>(16))
...
bool IMUserLatestNickNameRsp::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  ::google::protobuf::io::StringOutputStream unknown_fields_string(
  ...
  ::google::protobuf::io::CodedOutputStream unknown_fields_stream(
      &unknown_fields_string);
  // @@protoc_insertion_point(parse_start:IM.Server.IMUserLatestNickNameRsp)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(16383);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:IM.Server.IMUserLatestNickNameRsp)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:IM.Server.IMUserLatestNickNameRsp)
  return false;
#undef DO_
}

void IMUserLatestNickNameRsp::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:IM.Server.IMUserLatestNickNameRsp)
  // required uint64 user_id = 1;
  if (has_user_id()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt64(1, this->user_id(), output);
  }
  ...
  output->WriteRaw(unknown_fields().data(),
                   unknown_fields().size());
  // @@protoc_insertion_point(serialize_end:IM.Server.IMUserLatestNickNameRsp)
}

int IMUserLatestNickNameRsp::ByteSize() const {
  int total_size = 0;
...
void IMUserLatestNickNameRsp::CheckTypeAndMergeFrom(
    const ::google::protobuf::MessageLite& from) {
  MergeFrom(*::google::protobuf::down_cast<const IMUserLatestNickNameRsp*>(&from));
}

void IMUserLatestNickNameRsp::MergeFrom(const IMUserLatestNickNameRsp& from) {
  GOOGLE_CHECK_NE(&from, this);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_user_id()) {
      set_user_id(from.user_id());
...
void IMUserLatestNickNameRsp::CopyFrom(const IMUserLatestNickNameRsp& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool IMUserLatestNickNameRsp::IsInitialized() const {
  if ((_has_bits_[0] & 0x0000000f) != 0x0000000f) return false;

  return true;
}

void IMUserLatestNickNameRsp::Swap(IMUserLatestNickNameRsp* other) {
  if (other != this) {
    std::swap(user_id_, other->user_id_);
    std::swap(app_id_, other->app_id_);
    std::swap(domain_id_, other->domain_id_);
...
::std::string IMUserLatestNickNameRsp::GetTypeName() const {
  return "IM.Server.IMUserLatestNickNameRsp";
}
...
#ifndef _MSC_VER
const int IMUserNickNameUpdate::kUserIdFieldNumber;
const int IMUserNickNameUpdate::kAppIdFieldNumber;
const int IMUserNickNameUpdate::kDomainIdFieldNumber;
const int IMUserNickNameUpdate::kNickNameFieldNumber;
const int IMUserNickNameUpdate::kAttachDataFieldNumber;
#endif  // !_MSC_VER

IMUserNickNameUpdate::IMUserNickNameUpdate()
  : ::google::protobuf::MessageLite() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:IM.Server.IMUserNickNameUpdate)
}

void IMUserNickNameUpdate::InitAsDefaultInstance() {
}

IMUserNickNameUpdate::IMUserNickNameUpdate(const IMUserNickNameUpdate& from)
  : ::google::protobuf::MessageLite() {
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:IM.Server.IMUserNickNameUpdate)
}

void IMUserNickNameUpdate::SharedCtor() {
  ::google::protobuf::internal::GetEmptyString();
  _cached_size_ = 0;
  user_id_ = GOOGLE_ULONGLONG(0);
  app_id_ = 0u;
...
IMUserNickNameUpdate::~IMUserNickNameUpdate() {
  // @@protoc_insertion_point(destructor:IM.Server.IMUserNickNameUpdate)
  SharedDtor();
}

void IMUserNickNameUpdate::SharedDtor() {
  if (nick_name_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete nick_name_;
  }
  if (attach_data_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
...
void IMUserNickNameUpdate::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const IMUserNickNameUpdate& IMUserNickNameUpdate::default_instance() {
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  protobuf_AddDesc_IM_2eServer_2eproto();
#else
  if (default_instance_ == NULL) protobuf_AddDesc_IM_2eServer_2eproto();
...
IMUserNickNameUpdate* IMUserNickNameUpdate::default_instance_ = NULL;

IMUserNickNameUpdate* IMUserNickNameUpdate::New() const {
  return new IMUserNickNameUpdate;
}

void IMUserNickNameUpdate::Clear() {
#define OFFSET_OF_FIELD_(f) (reinterpret_cast<char*>(      \
  &reinterpret_cast<IMUserNickNameUpdate*>(16)->f) - \
   reinterpret_cast<char*>(16))
...
bool IMUserNickNameUpdate::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  ::google::protobuf::io::StringOutputStream unknown_fields_string(
  ...
  ::google::protobuf::io::CodedOutputStream unknown_fields_stream(
      &unknown_fields_string);
  // @@protoc_insertion_point(parse_start:IM.Server.IMUserNickNameUpdate)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(16383);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:IM.Server.IMUserNickNameUpdate)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:IM.Server.IMUserNickNameUpdate)
  return false;
#undef DO_
}

void IMUserNickNameUpdate::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:IM.Server.IMUserNickNameUpdate)
  // required uint64 user_id = 1;
  if (has_user_id()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt64(1, this->user_id(), output);
  }
  ...
  output->WriteRaw(unknown_fields().data(),
                   unknown_fields().size());
  // @@protoc_insertion_point(serialize_end:IM.Server.IMUserNickNameUpdate)
}

int IMUserNickNameUpdate::ByteSize() const {
  int total_size = 0;
...
void IMUserNickNameUpdate::CheckTypeAndMergeFrom(
    const ::google::protobuf::MessageLite& from) {
  MergeFrom(*::google::protobuf::down_cast<const IMUserNickNameUpdate*>(&from));
}

void IMUserNickNameUpdate::MergeFrom(const IMUserNickNameUpdate& from) {
  GOOGLE_CHECK_NE(&from, this);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_user_id()) {
      set_user_id(from.user_id());
...
void IMUserNickNameUpdate::CopyFrom(const IMUserNickNameUpdate& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool IMUserNickNameUpdate::IsInitialized() const {
  if ((_has_bits_[0] & 0x0000000f) != 0x0000000f) return false;

  return true;
}

void IMUserNickNameUpdate::Swap(IMUserNickNameUpdate* other) {
  if (other != this) {
    std::swap(user_id_, other->user_id_);
    std::swap(app_id_, other->app_id_);
    std::swap(domain_id_, other->domain_id_);
...
::std::string IMUserNickNameUpdate::GetTypeName() const {
  return "IM.Server.IMUserNickNameUpdate";
}
